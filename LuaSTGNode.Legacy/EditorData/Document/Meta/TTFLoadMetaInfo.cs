...
{
    public class TTFLoadMetaInfo : MetaInfo, IComparable<TTFLoadMetaInfo>
    {
        ...
        public TTFLoadMetaInfo(LoadTTF target) : base(target) { }

        public override void Create(IAggregatableMeta meta, MetaDataEntity documentMetaData)
        {
            documentMetaData.aggregatableMetas[(int)MetaType.TTFLoad].Add(meta);
        }

        public override void Remove(IAggregatableMeta meta, MetaDataEntity documentMetaData)
        {
            documentMetaData.aggregatableMetas[(int)MetaType.TTFLoad].Remove(meta);
        }
        ...
        public int CompareTo(TTFLoadMetaInfo other)
        {
